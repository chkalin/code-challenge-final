...
public class PostServiceImp implements PostService {
    ...
    @Override
    public Page<Post> findAllByUserInOrderedByDatePageable(Set<User> user_set, int page) {
        return postRepository.findAllByUserInOrderByCreateDateDesc(user_set, new PageRequest(subtractPageByOne(page), 5));
    }
